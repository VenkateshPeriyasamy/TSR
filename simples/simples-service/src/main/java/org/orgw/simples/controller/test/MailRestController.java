...
public class MailRestController  extends BaseController {
	...
	ILeaveService leaveservice;
	 ...
	 @RequestMapping(path="/user/leaverequestapprove",method= {RequestMethod.GET,RequestMethod.POST})
     public Response leaveRequestApprove(@RequestBody LeaveRequest request) throws BaseException {
        
        
         return response(this.leaveservice.leaverequestapprove(request));
