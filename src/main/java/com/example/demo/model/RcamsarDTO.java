...
public class RcamsarDTO {
	...
	public String toString() {
		return "RcamsarDTO [id=" + id + ", rollno=" + rollno + ", name=" + name + ", dob=" + dob + ", indosno="
				+ indosno + ", passedout=" + passedout + ", email=" + email + ", mobilenumber=" + mobilenumber
				+ ", department=" + department + ", course=" + course + ", batchno=" + batchno + "]";
	}
	
	public RcamsarDTO(){
		
	}
	public RcamsarDTO(String rollno, String name, String dob, String indosno, String passedout, String email,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RcamsarDTO other = (RcamsarDTO) obj;
		if (batchno == null) {
