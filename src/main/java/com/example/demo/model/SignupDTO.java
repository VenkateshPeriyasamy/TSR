...
public class SignupDTO {
	...
	@GeneratedValue(strategy=GenerationType.IDENTITY)
	    Long id;
	    public SignupDTO(Long id) {
		super();
		this.id = id;
	}
	    public SignupDTO(Long id, String rollno, String name, String dob, String indosno, String passedout,
				String email, String mobilenumber, String department, String course, String batchno, String action) {
			super();
			this.id = id;
			this.rollno = rollno;
			this.name = name;
		...
		public String toString() {
			return "SignupDTO [id=" + id + ", rollno=" + rollno + ", name=" + name + ", dob=" + dob + ", indosno="
					+ indosno + ", passedout=" + passedout + ", email=" + email + ", mobilenumber=" + mobilenumber
					+ ", department=" + department + ", course=" + course + ", batchno=" + batchno + ", action=" + action + "]";
		}
	    ...
	    public SignupDTO(String rollno, String name, String dob, String indosno, String passedout, String email,
