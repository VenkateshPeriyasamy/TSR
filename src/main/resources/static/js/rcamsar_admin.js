$(document).ready(function(){
    ...
    $('#dept, #course, #batchno').on('change', function(e) {
        e.preventDefault();
        RefreshTable("#example2","http://localhost:8080/rcamsar_alumni/datatable?department="+$('#dept').val()+"&course="+$('#course').val()+"&batchno="+$('#batchno').val());
    });
    ...
    delete_editor=new $.fn.dataTable.Editor( {
      ...
      $('#example2').DataTable({
           ajax: {
           url: 'http://localhost:8080/rcamsar_alumni/datatable?department='+$('#dept').val()+'&course='+$('#course').val()+"&batchno="+$('#batchno').val(),
           type: "GET",
      ...
      $('#example2').on('click', 'a.update_editor_edit', function (e) {
          e.preventDefault();
      ...
      $('#example2').on('click', 'a.delete_editor_remove', function (e) {
            e.preventDefault();
